...
<body>
    ...
    <audio id="okSound" preload="auto">
        <source src="{{ asset('sounds/ok.mp3') }}" type="audio/mpeg">
    </audio>
    ...
    <audio id="criticalSound" preload="auto">
        <source src="{{ asset('sounds/critical.mp3') }}" type="audio/mpeg">
    </audio>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            if (btn) {
                btn.addEventListener("click", function() {
                    ...
                    localStorage.setItem("alertSound", soundEnabled ? "on" : "off");

                    if (!soundEnabled) {
                        stopAlertSound(); // immediate mute
                    }
        ...
        document.addEventListener("click", function() {
            ...
            if (!audioUnlocked) {
                ...
                let sounds = [
                    ...
                    document.getElementById("criticalSound")
                ];
        ...
        function playAlertSound(type) {
            ...
            if (type === "ok") {
                currentSound = document.getElementById("okSound");
            }

            if (type === "warning") {
                currentSound = document.getElementById("warningSound");
            }

            if (type === "critical") {
                currentSound = document.getElementById("criticalSound");
            }
        ...
        function showAlertNotification(type, message,url) {
            ...
            if (type === "ok") {
                toastr.success(message, "OK Alert");
            }

            if (type === "warning") {
                toastr.warning(message, "Warning Alert");
            }
        ...
        setInterval(function() {
            ...
            $.get("ajax/alerts-api", function(data) {
                ...
                data.alerts.forEach(function(alert) {
                    ...
                    let message = alert.hostname + " : " + alert.rule_name;

                    

                    // LibreNMS alert page example
                    let url = "/alerts/" + alert.id;

                    showAlertNotification(type, message,url);
