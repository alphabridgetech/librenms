...
class PortStatisticsController
{
    public const COLUMNS = [
        ...
        'ifInUcastPkts' => 'Unicast Packets In Total',
        'ifInUcastPkts_prev' => 'Unicast Packets In Previous',
        'ifInUcastPkts_delta' => 'Unicast Packets In Change',
        'ifInUcastPkts_rate' => 'Unicast Packets In Rate',
        'ifOutUcastPkts' => 'Unicast Packets Out Total',
        'ifOutUcastPkts_prev' => 'Unicast Packets Out Previous',
        'ifOutUcastPkts_delta' => 'Unicast Packets Out Change',
        'ifOutUcastPkts_rate' => 'Unicast Packets Out Rate',
    ...
    public function export(Request $request)
    {
        ...
        $headers = [
            ...
            'Unicast In Rate (pps)',
            'Unicast Out Total',
            'Unicast Out Previous',
            'Unicast Out Change',
            'Unicast Out Rate (pps)',
            'In Errors',
            'Out Errors',
            'In Error Rate',
            'Out Error Rate',
        ...
        $row = $port ? [
            ...
            $port->ifInUcastPkts,
            $port->ifInUcastPkts_prev,
            $port->ifInUcastPkts_delta,
            $port->ifInUcastPkts_rate,
            $port->ifOutUcastPkts,
            $port->ifOutUcastPkts_prev,
            $port->ifOutUcastPkts_delta,
            $port->ifOutUcastPkts_rate,
            $port->ifInErrors,
            $port->ifOutErrors,
    ...
    private function values(Port $port): array
    {
        return [
            ...
            'ifInUcastPkts' => $port->ifInUcastPkts,
            'ifInUcastPkts_prev' => $port->ifInUcastPkts_prev,
            'ifInUcastPkts_delta' => $port->ifInUcastPkts_delta,
            'ifInUcastPkts_rate' => Number::formatSi($port->ifInUcastPkts_rate, 2, 0, 'pps'),
            'ifOutUcastPkts' => $port->ifOutUcastPkts,
            'ifOutUcastPkts_prev' => $port->ifOutUcastPkts_prev,
            'ifOutUcastPkts_delta' => $port->ifOutUcastPkts_delta,
