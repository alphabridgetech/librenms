...
class PortsController extends TableController
{
    ...
    protected function formatExportRow($port)
    {
        ...
        return [
            ...
            'unicast_in_total' => $port->ifInUcastPkts,
            'unicast_in_prev' => $port->ifInUcastPkts_prev,
            'unicast_in_delta' => $port->ifInUcastPkts_delta,
            'unicast_in_rate' => $port->ifInUcastPkts_rate,
            'unicast_out_total' => $port->ifOutUcastPkts,
            'unicast_out_prev' => $port->ifOutUcastPkts_prev,
            'unicast_out_delta' => $port->ifOutUcastPkts_delta,
            'unicast_out_rate' => $port->ifOutUcastPkts_rate,
